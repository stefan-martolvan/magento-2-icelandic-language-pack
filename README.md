...
2. [Install Icelandic Language Pack](#2-how-to-install-hungarian-language-pack)
3. [How to active Icelandic language pack](#3-how-to-active-hungarian-language-pack)
...
## 3. How to active Icelandic language pack {#active}
